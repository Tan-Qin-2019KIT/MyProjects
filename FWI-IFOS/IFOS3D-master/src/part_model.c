...
int nsnap, i, j, k, is, ks, aperx, aperz, ntr=0, itr, nsrc, l, c, safe, ishot, imin, imax, kmin, kmax, h;
int * stype=NULL;
float vp, xsrc, ysrc, zsrc, tshift, xrec, yrec, zrec, Xr1, Xr2, Zr1, Zr2, Xm1, Xm2, Zm1, Zm2, xmin, xmax, zmin, zmax;
float Ax, Az, xc, zc, rho;
...
imin = ((int)ceil((float)(xmin/DX))) - FW - A;
imax = ((int)ceil((float)(xmax/DX))) + FW + A + 1;
kmin = ((int)ceil((float)(zmin/DZ))) - FW - A;
kmax = ((int)ceil((float)(zmax/DZ))) + FW + A;
