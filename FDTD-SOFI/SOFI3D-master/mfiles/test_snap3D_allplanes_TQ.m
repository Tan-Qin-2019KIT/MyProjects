...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
nx=400; ny=100; nz=50; % basic grid size; ny=vertical
...
file_inp1='../par/snap/snap_2layer_TQ.bin.div';
% Input file2 (snapshot file2)
file_inp2='../par/snap/snap_2layer_TQ.bin.curl';
% Model file (for single display or contour plot ontop of snapshot)
file_mod='../par/model/2layer_TQ.SOFI3D.rho';
...
caxis_value_1=1e-4;
caxis_value_2=1e-4; % only used if num_switch=2
