...
t=0:1e-10:100e-9;
srcpulse=blackharrispulse(centralfreq,t);
...
srcz = (0.5:0.5:0.5)';
srcx0=0;recx0=10;
srcx = srcx0*ones(size(srcz));

re
cz = (0.5:0.5:10.5)';
recx = recx0*ones(size(recz));
...
% pick fist arrival
d_obs=pickfisrtall(gather,13);
d_obs=d_obs.*(tout(2)-tout(1)).*1e9;