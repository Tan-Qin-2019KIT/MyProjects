...
#define PMIX_CONFIGURE_CLI " \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-debug\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/libevent2022/libevent2022.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/hwloc201/hwloc201.h\"' \'--prefix=/where/to/install\' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/home/qtan/Downloads/openmpi-4.0.1 -I/home/qtan/Downloads/openmpi-4.0.1 -I/home/qtan/Downloads/openmpi-4.0.1/opal/include -I/home/qtan/Downloads/openmpi-4.0.1/opal/include -I/home/qtan/Downloads/openmpi-4.0.1/opal/mca/event/libevent2022/libevent -I/home/qtan/Downloads/openmpi-4.0.1/opal/mca/event/libevent2022/libevent/include -I/home/qtan/Downloads/openmpi-4.0.1/opal/mca/hwloc/hwloc201/hwloc/include  \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Thu Apr  4 17:15:03 CEST 2019"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "gpiag26"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "qtan"
...
#define PMIX_PACKAGE_STRING "PMIx qtan@gpiag26 Distribution"
