...
Range_initional=[1.55,1.66,1.75];               gain=[1,0.85,0.6]; 
...
Acculating_Pulse_Number = 10;     %acculating the number of echo 
...
for j = 1 :length(EbNo)    
  ...
  %-----------------Generate HRRP of moving target--------------
   ...
   Range_Current = Range_initional + Time_update_scans * target_v * ( nn - 1) ;
